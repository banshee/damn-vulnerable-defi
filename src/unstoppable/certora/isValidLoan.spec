...
rule isValidLoan() {
    ...
    require(currentContract.asset == simpleToken, "only testing with simpleToken");
    bool validLoan = isValidLoan(e, currentContract, receiver, simpleToken, amount);
    currentContract.flashLoan(e, receiver, simpleToken, amount, data);
